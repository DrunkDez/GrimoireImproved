...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      aboutOwnerTitle: settings.aboutOwnerTitle || "About the Owner",
      aboutOwnerText: settings.aboutOwnerText || "",
      aboutOwnerImage: settings.aboutOwnerImage || "",
      aboutSiteTitle: settings.aboutSiteTitle || "About the Site",
      aboutSiteText: settings.aboutSiteText || "",
      aboutSectionOrder: settings.aboutSectionOrder || "owner,site",
